...
이 장은 [04_branch_strategy/LAB.md](C:\Users\angpa\myProjects\Daily_Work\GitLab-Manual\tutorials\04_branch_strategy\LAB.md) 와 함께 진행한다.

이번 장에서 새로 추가하는 파일:

- [docs/branch-planning.md](C:\Users\angpa\myProjects\Daily_Work\GitLab-Manual\tutorials\04_branch_strategy\assets\docs\branch-planning.md)
- [src/feature-flags.json](C:\Users\angpa\myProjects\Daily_Work\GitLab-Manual\tutorials\04_branch_strategy\assets\src\feature-flags.json)
...
- 강의 노트만으로 진행하는 순서:
  ...
  - [04_branch_strategy/LAB.md](C:\Users\angpa\myProjects\Daily_Work\GitLab-Manual\tutorials\04_branch_strategy\LAB.md)는 팀 실습 순서를 빠르게 확인할 때만 본다
- 이 장에서 반드시 눈으로 확인할 것:
...
```powershell
Copy-Item ..\tutorials\04_branch_strategy\assets\docs\branch-planning.md .\docs\
Copy-Item ..\tutorials\04_branch_strategy\assets\src\feature-flags.json .\src\
...
[05_GitLab_Project_Structure_Permissions_and_MR.md](./05_GitLab_Project_Structure_Permissions_and_MR.md) 에서 GitLab 역할, 보호 브랜치, MR, approval 흐름을 운영 관점으로 정리한다.
