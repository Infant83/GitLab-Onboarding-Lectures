...
이 장은 [03_history_recovery/LAB.md](C:\Users\angpa\myProjects\Daily_Work\GitLab-Manual\tutorials\03_history_recovery\LAB.md) 와 함께 진행한다.

이번 장에서 새로 추가하는 파일:

- [docs/release-notes-draft.md](C:\Users\angpa\myProjects\Daily_Work\GitLab-Manual\tutorials\03_history_recovery\assets\docs\release-notes-draft.md)
- [tests/role-policy.test.js](C:\Users\angpa\myProjects\Daily_Work\GitLab-Manual\tutorials\03_history_recovery\assets\tests\role-policy.test.js)
...
```powershell
Copy-Item ..\tutorials\03_history_recovery\assets\docs\release-notes-draft.md .\docs\
Copy-Item ..\tutorials\03_history_recovery\assets\tests\role-policy.test.js .\tests\
...
- 강의 노트만으로 진행하는 순서:
  ...
  - [03_history_recovery/LAB.md](C:\Users\angpa\myProjects\Daily_Work\GitLab-Manual\tutorials\03_history_recovery\LAB.md)는 단계 요약본으로만 쓴다
- 이 장에서 반드시 눈으로 확인할 것:
...
[04_Branch_Strategy_and_Sync_Decisions.md](./04_Branch_Strategy_and_Sync_Decisions.md) 에서 브랜치 전략과 merge / rebase / fork 같은 협업 의사결정을 다룬다.
