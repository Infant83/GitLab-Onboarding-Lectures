# CH05 Skywork Run Prompt v2

이번 작업은 `GitLab-Onboarding-Lectures` 8챕터 시리즈 중 `CH05` 단독 프레젠테이션 생성이다.
...
source-of-truth 규칙:
- 반드시 `@CH05-GitLab-Project-Structure-Permissions-and-MR_lecture-note.md`를 참조 파일로 걸어 사용하라.
- `CH05-GitLab-Project-Structure-Permissions-and-MR_lecture-note.md`를 source of truth로 사용하라.
