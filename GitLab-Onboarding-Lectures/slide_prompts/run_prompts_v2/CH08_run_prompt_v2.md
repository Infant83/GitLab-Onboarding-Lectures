# CH08 Skywork Run Prompt v2

이번 작업은 `GitLab-Onboarding-Lectures` 8챕터 시리즈 중 `CH08` 단독 프레젠테이션 생성이다.
...
source-of-truth 규칙:
- 반드시 `@CH08-Capstone-Scenario-and-Role-Based-Playbook_lecture-note.md`를 참조 파일로 걸어 사용하라.
- `CH08-Capstone-Scenario-and-Role-Based-Playbook_lecture-note.md`를 source of truth로 사용하라.
